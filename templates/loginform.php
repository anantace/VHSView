    ...
    <div class="index_container">
        ...
        <? if ($loginerror): ?>
            ...
            <?= MessageBox::error(_('Bei der Anmeldung trat ein Fehler auf!'), [
                $error_msg,
		sprintf(_("Beachten Sie, dass beteiligte Volkshochschulen jeweils eigene Plattformen betreiben. Um auf Kurse einer VHS zuzugreifen loggen Sie sich ein unter (Name der VHS).elan-ev.de  (Beispiel: ammerland.elan-ev.de)")) . 
                sprintf(
        ...
        <div class="index_main">
            <form class="vhs-login default" name="login" method="post" action="<?= URLHelper::getLink(Request::url(), array('cancel_login' => NULL)) ?>" style="width: 400px;">
                <header>
